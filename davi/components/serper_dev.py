...
@component
class CustomSerperDevWebSearch:
    """
    ...
    def __init__(
        ...
        """
        Initialize the CustomSerperDevWebSearch component.
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "CustomSerperDevWebSearch":
        """
        Serializes the component to a dictionary.
    ...
    def run(self, query: str, allowed_domains: Optional[List[str]] = None) -> Dict[str, Union[List[Document], List[str]]]:
        """
